...
def home():
    if request.method =="POST":
        ...
        # 
        if prediction == 1:
            prediction = " Person Has No Risk Of Stroke"
        else:
            prediction = "Person Has Chances Of Having Strokes"

        return render_template("result.html", prediction_text="Probablity of Heart-Stroke in future is --> {}".format(prediction))   
